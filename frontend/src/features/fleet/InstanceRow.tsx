  ...
  return (
    ...
    >
      <div className="flex items-center gap-2">
        ...
        {/* Every agent is kept, so "kept" says nothing. What is worth knowing at
            a glance is that this one works on a timer — that it may be doing
            something while you are not looking. */}
